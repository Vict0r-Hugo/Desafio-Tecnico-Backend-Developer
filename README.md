...
## Baixando SQLITE
   ...
   - Execute o codigo abaixo e insira a query SQL no terminal para verificar o banco do "CRM"

    C:\sqlite\sqlite3.exe inventory.db

   - Execute o codigo abaixo e insira a query SQL no terminal para verificar o banco do "Protheus"
     
    C:\sqlite\sqlite3.exe protheus.db

   - Com a extensão do VSCode "Database Client" é possivel conectar ao banco parar e verificar de forma visual
